...
<!-- Custom Joomla Differentiator Badge (Admin) -->
<style>
    #joomla-site-diff-badge-admin {
        position: fixed;
        top: 8px;
        left: 200px;
    ...
    #joomla-site-diff-badge-admin .pulse-dot {
        width: 6px;
        height: 6px;
...
<div id="joomla-site-diff-badge-admin">
    <div class="pulse-dot"></div>
    <span>Joomla Principal</span>
</div>
</body>
</html>
