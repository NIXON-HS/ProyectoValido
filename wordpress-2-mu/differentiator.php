<?php
/*
Plugin Name: Site Differentiator - Servidor
Description: Displays a floating badge identifying this as the Servidor WordPress instance.
Version: 1.0
Author: Antigravity
*/
...
function wp_diff_badge_servidor() {
    ...
    <div id="wp-site-diff-badge">
        ...
        <span>WordPress Servidor</span>
    </div>
    <?php
}

add_action('wp_footer', 'wp_diff_badge_servidor', 9999);
add_action('admin_footer', 'wp_diff_badge_servidor', 9999);
